...
public class Game {
    ...
    Game(Statistics stats) {
        ...
        Msg[1] = "";
        MsgB[0] = "Games Played: " + S.gplayed + " Current Games: " + S.currentg + " X Wins: " + S.xwins + "      O Wins: " + S.owins + "      Draws: " + S.draws;
        MsgB[1] = "Games Played: " + S.gplayed + " Current Games: " + S.currentg + " X Wins: " + S.xwins + "      O Wins: " + S.owins + "      Draws: " + S.draws;
    }
